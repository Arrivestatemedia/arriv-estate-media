# Training Admin System — Admin Page

## `src/pages/SalesTrainingAdmin.jsx`

> The main admin dashboard. Three tabs: Dashboard (stats + requirements), Modules (full module manager), Roster (certifications with calling auth, roleplay/practicum evaluation, certify/suspend/restore).
