# Training Admin System — Rep-Facing Portal

## `src/pages/SalesTrainingPortal.jsx`

> Simple wrapper page that renders the training content component.
...
> The rep-facing training experience: module list with sequential unlocking, video player with seek-detection and 95% watch requirement, quiz interface with critical question enforcement, and certification status display.
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h2 className="text-lg font-semibold text-[#1A1A1A]">Sales Certification</h2>
      </div>
