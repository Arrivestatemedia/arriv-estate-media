    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-radius:14px;border:1px solid rgba(184,149,106,0.25);overflow:hidden;">
        ...
        <tr><td style="padding:40px 44px;">
          ...
          <h2 style="margin:28px 0 12px;font-size:18px;color:#B8956A;">Check Your Application Status</h2>
          <table cellpadding="0" cellspacing="0" style="margin:0 0 20px;">
            <tr><td style="border-radius:8px;background-color:#B8956A;">
              <a href="${portalUrl}" style="display:inline-block;padding:13px 28px;font-size:16px;font-weight:600;color:#1A1A1A;text-decoration:none;border-radius:8px;">Candidate Portal</a>
            </td></tr>
          </table>
          <p style="margin:0 0 6px;font-size:16px;line-height:1.6;color:#1A1A1A;">There you'll be able to:</p>
          ...
          <p style="margin:0 0 20px;font-size:16px;line-height:1.6;color:#1A1A1A;">Thank you again for your interest in Arriv Estate Media.</p>
          <p style="margin:0 0 4px;font-size:16px;line-height:1.6;color:#1A1A1A;">We appreciate your time and look forward to reviewing your application.</p>
        </td></tr>
