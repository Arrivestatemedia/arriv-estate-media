...
<html><body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p>Best regards,<br><strong>Bradley Burke</strong><br>Arriv Estate Media<br>📞 678-242-9107<br>🌐 arrivestatemedia.com</p>
      ...
      try {
        ...
        // Refund policy small print — anchored just above the footer
        const refundPolicyLines = doc.splitTextToSize(
        ...
        const refundBlockHeight = 10 + refundPolicyLines.length * 9 + 10; // title + lines + padding
        const refundY = pageHeight - 55 - refundBlockHeight;
        doc.setFont('helvetica', 'bold');
        doc.setFontSize(7.5);
        doc.setTextColor(120, 120, 120);
        doc.text('*Refund Policy', margin, refundY);
        doc.setFont('helvetica', 'normal');
        doc.text(refundPolicyLines, margin, refundY + 10);
