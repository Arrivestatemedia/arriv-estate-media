    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-radius:14px;border:1px solid rgba(184,149,106,0.25);overflow:hidden;">
        ...
        <tr><td style="padding:40px 44px;">
          ...
          <p style="margin:0 0 20px;font-size:16px;line-height:1.6;color:#1A1A1A;">We're currently targeting our first Media Partner activations in mid-August and will keep you updated along the way.</p>
          <p style="margin:0 0 20px;font-size:16px;line-height:1.6;color:#1A1A1A;">Thank you again for believing in Arriv. We can't wait to welcome you officially.</p>
        </td></tr>
