  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        <select className="border rounded px-3 py-1.5 text-sm" value={job?.status || "draft"} onChange={e => setStatus(e.target.value)}>
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap justify-between items-center gap-2">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" onClick={onCompare}><GitCompare className="w-4 h-4 mr-2" /> Compare</Button>
      ...
      {tab === "ranking" && (
        <div className="space-y-4">
          <div className="flex justify-end">
            <Button variant="outline" onClick={onCompare}><GitCompare className="w-4 h-4 mr-2" /> Compare Candidates</Button>
          </div>
