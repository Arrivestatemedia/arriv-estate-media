      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="border rounded-lg p-4">
            ...
            {candidate?.decision !== "pending" && candidate?.decision && <p className="text-xs text-gray-500 mt-2">Current decision: <span className="font-semibold capitalize">{candidate.decision.replace(/_/g, " ")}</span></p>}
          </div>
        </div>
      </div>
