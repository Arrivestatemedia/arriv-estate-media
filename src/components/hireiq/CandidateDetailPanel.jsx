        ...
        <div className="space-y-5">
          ...
          <div className="p-5" style={card}>
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button size="sm" variant={candidate?.decision === "advance" ? "default" : "outline"} disabled style={candidate?.decision === "advance" ? { backgroundColor: GOLD, color: "#0A0A0A", border: "none", fontWeight: 600, opacity: 0.6 } : { backgroundColor: "transparent", color: CREAM, border: "1px solid rgba(184,149,106,0.2)", opacity: 0.5 }}><CheckCircle2 className="w-4 h-4 mr-1" /> Advance</Button>
              <Button size="sm" variant={candidate?.decision === "hold" ? "default" : "outline"} disabled style={candidate?.decision === "hold" ? { backgroundColor: GOLD, color: "#0A0A0A", border: "none", fontWeight: 600, opacity: 0.6 } : { backgroundColor: "transparent", color: CREAM, border: "1px solid rgba(184,149,106,0.2)", opacity: 0.5 }}><Clock className="w-4 h-4 mr-1" /> Hold</Button>
              <Button size="sm" variant={candidate?.decision === "another_interview" ? "default" : "outline"} disabled style={candidate?.decision === "another_interview" ? { backgroundColor: GOLD, color: "#0A0A0A", border: "none", fontWeight: 600, opacity: 0.6 } : { backgroundColor: "transparent", color: CREAM, border: "1px solid rgba(184,149,106,0.2)", opacity: 0.5 }}><Mic className="w-4 h-4 mr-1" /> Another Interview</Button>
              <Button size="sm" variant={candidate?.decision === "offer" ? "default" : "outline"} disabled style={candidate?.decision === "offer" ? { backgroundColor: GOLD_DARK, color: CREAM, border: "none", fontWeight: 600, opacity: 0.6 } : { backgroundColor: "transparent", color: CREAM, border: "1px solid rgba(184,149,106,0.2)", opacity: 0.5 }}><CheckCircle2 className="w-4 h-4 mr-1" /> Offer Position</Button>
              <Button size="sm" variant={candidate?.decision === "decline" ? "default" : "outline"} disabled style={candidate?.decision === "decline" ? { backgroundColor: "#991b1b", color: CREAM, border: "none", fontWeight: 600, opacity: 0.6 } : { backgroundColor: "transparent", color: CREAM, border: "1px solid rgba(184,149,106,0.2)", opacity: 0.5 }}><AlertCircle className="w-4 h-4 mr-1" /> Decline</Button>
            </div>
