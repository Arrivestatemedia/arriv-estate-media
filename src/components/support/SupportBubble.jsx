...
export default function SupportBubble() {
  ...
  return (
    <button
      ...
      className="fixed z-[60] bottom-4 left-4 md:bottom-6 md:left-6 flex items-center justify-center w-14 h-14 rounded-full bg-[#2563EB] text-white shadow-lg hover:bg-[#1D4ED8] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-2"
