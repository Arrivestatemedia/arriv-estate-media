...
import { Loader2, Clock, Brain, Video, CheckCircle2, AlertCircle, RefreshCw, ChevronRight, Film, Play, CalendarClock } from "lucide-react";
...
export default function AsyncInterviewManagerContent() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" style={{ ...SERIF, color: TEXT_DARK }}>Async Interviews</h1>
        ...
        <button
          ...
          style={{ border: `1px solid ${GOLD}30`, color: "rgba(26,26,26,0.7)" }}
        >
      ...
      {/* Tab toggle */}
      <div className="flex gap-1 bg-white rounded-xl border p-1" style={{ border: `1px solid ${GOLD}15` }}>
        <button
