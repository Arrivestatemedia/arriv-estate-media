...
export default function ConvertToAiButton({ conference, onConverted }) {
  ...
  const handleConvert = async () => {
    if (
      !confirm(
        "Convert this interview to use the AI interviewer? The existing meeting link will NOT change — the applicant will join the same URL and be interviewed by AI instead of a human."
      )
    ) {
      return;
    }
