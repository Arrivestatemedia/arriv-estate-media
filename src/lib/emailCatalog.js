...
export const EMAIL_CATALOG = [
  ...
  { key: "inviteToAsyncInterview", name: "Async Interview Invitation", category: "Interview", description: "Sent when a candidate is invited to complete a first-round async interview (48-hour deadline, candidate chooses Conversational AI or Self-Guided Video)", variables: ["firstName", "positionTitle", "interviewUrl", "deadlineDisplay"], defaultSubject: "Arriv Estate Media | Complete Your First-Round Interview" },
