  ...
  useEffect(() => {
    const processCallback = async () => {
      try {
        ...
        const response = await base44.functions.invoke('exchangeSalesRepGmailCode', { code, state });
        setStatus('success');
        
        // Redirect back to admin sales page after 2 seconds
        setTimeout(() => {
      ...
      <div className="text-center">
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-gray-600">Gmail has been authorized. Redirecting...</p>
          </>
        )}
        {status === 'error' && (
          <>
