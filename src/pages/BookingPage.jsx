            ...
            <div className="px-6 pb-6 space-y-3">
              ...
              <div className="mt-4 pt-4 border-t border-[#1A1A1A]/10">
                <p className="text-xs text-[#1A1A1A]/70 mb-3">
                  <strong>This pricing is up to 2,500 sq ft.</strong> Includes properties up to 2,500 sq. ft. Enter the property address to see exact pricing for this package.
                </p>
