...
import { Award, Phone, PhoneOff, AlertTriangle, CheckCircle2, XCircle, Shield, RefreshCw, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#FFFBF5] p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-[#1A1A1A] mb-1">Sales Training Admin</h1>
            <p className="text-slate-600">Manage team certification, role-play, practicum, and calling authorization</p>
          </div>
