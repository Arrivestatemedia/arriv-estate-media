  ...
  try {
    ...
    if (!booking.request_pay_at_closing) {
      try {
        ...
        const templateUrl = 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/698b3b9e4b7d348873dbf213/7c603d171_Arriv_Estate_Media_Pay_Up_Front_Invoice.docx';
        ...
        // Step 1: Replace sentinel with "Pay Now" text
